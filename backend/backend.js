...
export async function getHtmlData() {
  return get('html') || initialData;
}

/* @expose */
export async function getCssData() {
  return get('css');
}

/* @expose */
export async function saveHtml(page, css) {
  await update('html', (html = initialData) => {
    html = page;
    return html;
  });
  await update('css', (prevCss = '') => {
    prevCss = css;
    return prevCss;
  });
}

const initialData = `<header class="header-banner">
...
<div class="container-width">
  <div class="am-container">
    <img onmousedown="return false" src="./img/phone-app.png" id="in5uyb" class="img-phone"/>
